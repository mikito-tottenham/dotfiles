---
name: docs-evaluator
description: "Evaluate a repository's documentation system when asked for a broad docs audit: AI-readability, source-of-truth and entrypoint conflicts, link/reachability, stale/deprecated docs, freshness and TODO governance, ADR-vs-canonical separation, metadata/front matter hygiene, and contradiction/gap analysis across README, AGENTS, CLAUDE.md, docs, specs, and skills. Produces an artifact-backed Markdown report and does not edit the target docs."
---
